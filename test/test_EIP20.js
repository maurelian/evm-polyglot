...
const vyper_EIP20Abstraction = artifacts.require('vyper_eip20');
const solidity_EIP20Abstraction = artifacts.require('solidity_EIP20');

test(vyper_EIP20Abstraction, 'Vyper')
test(solidity_EIP20Abstraction, 'Solidity')


function test(EIP20Abstraction, lang) {
  let HST;
